...
export default function SignUpPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // 2. Auto-create landlord organisation
            ...
            if (orgError) {
                toast.error(
                    "Account created, but organisation setup failed. Please sign in and create an organisation manually."
                );
                return;
            }

            toast.success("Welcome to KEJANI!");
            router.push("/");
            router.refresh();
        } catch (err) {
    ...
    const handleSocialLogin = (provider: string) => {
        ...
        // Future wiring: authClient.signIn.social({ provider: provider.toLowerCase(), callbackURL: "/" });
    };
